...
#### Brain (LLM)
##### Attack
- **Zihao Wang et al.** (2023). *Describe, explain, plan and select: interactive planning with llms enables open-world multi-task agents*. [Paper](https://arxiv.org/abs/2302.01560)
